			...
			<% if $allNews %>
                ...
                <div class='row pagination pagination-sm'>
					<% if $allNews.NotFirstPage %>
                        <li>
                            <a class='<%t NewsHolderPage.PREVIOUS_PAGE "Previous" %>'
                               href="$allNews.PrevLink"><%t NewsHolderPage.PREVIOUS_PAGE "Previous" %></a>
                        </li>
					<% end_if %>
					<% loop $allNews.PaginationSummary %>
						...
						<% else %>
							<% if $Link %>
                                <li>
                                    <a href="$Link"
                                       title='<%t NewsHolderPage.JUMPTO_PAGE "Jump to page" %> $PageNum'>$PageNum</a>
                                </li>
							<% else %>
                                <li class="disabled">
                                    <a>...</a>
					...
					<% if $allNews.NotLastPage %>
                        <li>
                            <a class='<%t NewsHolderPage.NEXT_PAGE "Next" %>'
                               href="$allNews.NextLink"><%t NewsHolderPage.NEXT_PAGE "Next" %></a>
                        </li>
					<% end_if %>
                </div>
			<% end_if %>
